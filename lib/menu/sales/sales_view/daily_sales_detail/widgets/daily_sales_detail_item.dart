...
class DailySalesDetailItem extends StatefulWidget {
  final Map<String, dynamic> data;
  const DailySalesDetailItem({super.key, this.data = const {}});

  @override
  State<DailySalesDetailItem> createState() => _DailySalesDetailItemState();
}

class _DailySalesDetailItemState extends State<DailySalesDetailItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          AmountTitle(saleDe: widget.data['saleDe']),
          Container(
