...
class MonthlyTotalSalesItem extends StatelessWidget {
  final Map<String, dynamic> data;
  final bool isLast;
  const MonthlyTotalSalesItem({
    super.key,
    this.data = const {},
    this.isLast = false,
  });
  ...
  Widget build(BuildContext context) {
    String date = data['saleMth'];
    String formattedDate = "${date.substring(2, 4)}.${date.substring(4, 6)}";
    return SizedBox(
