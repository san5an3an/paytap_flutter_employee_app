...
/// 현금영수증 승인 내역 화면의 상태 모델
class CashReceiptApprovalHistoryState {
  final Map<String, dynamic> searchState;
  final bool isLoading;
  final bool isInitialLoading;
  final bool isInitialized;
  final List originalList;
  final List<Map<String, dynamic>> cashReceiptApprovalHistoryItemList;
  final SearchConfig searchConfig;

  CashReceiptApprovalHistoryState({
    required this.searchState,
    this.isLoading = false,
    this.isInitialLoading = false,
    this.isInitialized = false,
    this.originalList = const [],
    this.cashReceiptApprovalHistoryItemList = const [],
  ...
  CashReceiptApprovalHistoryState copyWith({
    Map<String, dynamic>? searchState,
    bool? isLoading,
    bool? isInitialLoading,
    bool? isInitialized,
    List? originalList,
    List<Map<String, dynamic>>? cashReceiptApprovalHistoryItemList,
    SearchConfig? searchConfig,
  }) {
    return CashReceiptApprovalHistoryState(
      searchState: searchState ?? this.searchState,
      isLoading: isLoading ?? this.isLoading,
      isInitialLoading: isInitialLoading ?? this.isInitialLoading,
      isInitialized: isInitialized ?? this.isInitialized,
      originalList: originalList ?? this.originalList,
      cashReceiptApprovalHistoryItemList:
          cashReceiptApprovalHistoryItemList ??
          this.cashReceiptApprovalHistoryItemList,
...
class CashReceiptApprovalHistoryScreenModel
    extends Notifier<CashReceiptApprovalHistoryState> {
  ...
  @override
  CashReceiptApprovalHistoryState build() {
    // dispose 콜백 등록
    ref.onDispose(() {
  ...
  Future<void> initializeData(BuildContext context) async {
    ...
    await getCashReceiptApprovalHistory(context);
  }
  ...
  void updateSearchState(Map<String, dynamic> newState, BuildContext context) {
    ...
    getCashReceiptApprovalHistory(context);
  }

  /// 데이터 초기화
  Future<void> resetCashReceiptApprovalHistoryList() async {
    final updatedState = Map<String, dynamic>.from(state.searchState);
  ...
  /// 데이터 조회
  Future<void> getCashReceiptApprovalHistory(BuildContext context) async {
    ...
    Map<String, dynamic> res = await PaymentService.getAppSaleCash(data);
    ...
    if (res['results'].length > 0) {
      ...
      final convertData = convertCashReceiptApprovalHistoryItemData(
        updatedOriginalList,
      );
      ...
      state = state.copyWith(
        ...
        cashReceiptApprovalHistoryItemList: convertData,
      );
    }
  }
  ...
  Future<void> refreshData(BuildContext context) async {
    ...
    try {
      await resetCashReceiptApprovalHistoryList();
      await getCashReceiptApprovalHistory(context);
    } finally {
  ...
  List<Map<String, dynamic>> convertCashReceiptApprovalHistoryItemData(
    List<dynamic> list,
  ) {
...
final cashReceiptApprovalHistoryScreenModelProvider =
    NotifierProvider.autoDispose<
      CashReceiptApprovalHistoryScreenModel,
      CashReceiptApprovalHistoryState
    >(CashReceiptApprovalHistoryScreenModel.new);
