...
/// 사용자 등록 내역 화면의 상태 모델
class UserRegisterHistoryState {
  final Map<String, dynamic> searchState;
  final bool isLoading;
  final bool isInitialLoading;
  final bool isInitialized;
  final List originalList;
  final List<Map<String, dynamic>> userRegisterHistoryItemList;
  final SearchConfig searchConfig;

  UserRegisterHistoryState({
    required this.searchState,
    this.isLoading = false,
    this.isInitialLoading = false,
    this.isInitialized = false,
    this.originalList = const [],
    this.userRegisterHistoryItemList = const [],
  ...
  UserRegisterHistoryState copyWith({
    Map<String, dynamic>? searchState,
    bool? isLoading,
    bool? isInitialLoading,
    bool? isInitialized,
    List? originalList,
    List<Map<String, dynamic>>? userRegisterHistoryItemList,
    SearchConfig? searchConfig,
  }) {
    return UserRegisterHistoryState(
      searchState: searchState ?? this.searchState,
      isLoading: isLoading ?? this.isLoading,
      isInitialLoading: isInitialLoading ?? this.isInitialLoading,
      isInitialized: isInitialized ?? this.isInitialized,
      originalList: originalList ?? this.originalList,
      userRegisterHistoryItemList:
          userRegisterHistoryItemList ?? this.userRegisterHistoryItemList,
...
class UserRegisterHistoryScreenModel
    extends Notifier<UserRegisterHistoryState> {
  ...
  @override
  UserRegisterHistoryState build() {
    // dispose 콜백 등록
    ref.onDispose(() {
  ...
  Future<void> initializeData(BuildContext context) async {
    ...
    await getUserRegisterHistory(context);
  }
  ...
  void updateSearchState(Map<String, dynamic> newState, BuildContext context) {
    ...
    getUserRegisterHistory(context);
  }

  /// 데이터 초기화
  Future<void> resetUserRegisterHistoryList() async {
    final updatedState = Map<String, dynamic>.from(state.searchState);
  ...
  /// 데이터 조회
  Future<void> getUserRegisterHistory(BuildContext context) async {
    ...
    Map<String, dynamic> res = await PaymentService.getAppSaleManual(data);
    ...
    if (res['results'].length > 0) {
      ...
      final convertData = convertUserRegisterHistoryItemData(
        updatedOriginalList,
      );
      ...
      state = state.copyWith(
        ...
        userRegisterHistoryItemList: convertData,
      );
    }
  }
  ...
  Future<void> refreshData(BuildContext context) async {
    ...
    try {
      await resetUserRegisterHistoryList();
      await getUserRegisterHistory(context);
    } finally {
  ...
  List<Map<String, dynamic>> convertUserRegisterHistoryItemData(
    List<dynamic> list,
  ) {
...
final userRegisterHistoryScreenModelProvider =
    NotifierProvider.autoDispose<
      UserRegisterHistoryScreenModel,
      UserRegisterHistoryState
    >(UserRegisterHistoryScreenModel.new);
